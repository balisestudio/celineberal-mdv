...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "media" (
  	...
  	"sizes_2xl_url" varchar,
  	"sizes_2xl_width" numeric,
  	"sizes_2xl_height" numeric,
  	"sizes_2xl_mime_type" varchar,
  	"sizes_2xl_filesize" numeric,
  	"sizes_2xl_filename" varchar
  );
  ...
  CREATE INDEX "media_sizes_2xl_sizes_2xl_filename_idx" ON "media" USING btree ("sizes_2xl_filename");
