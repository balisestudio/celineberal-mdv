...
export const getLots = unstable_cache(
	async ({
		auctionId,
		page = 1,
		sort = "lotNumber",
...
export const getLotByAuctionSlugAndLotNumber = unstable_cache(
	async (auctionSlug: string, lotNumber: string, locale?: string) => {
	...
	["data/lots/getLotByAuctionSlugAndLotNumber"],
	{ tags: ["lots"] },
);

export const getPrevLot = unstable_cache(
	async (
		auctionId: number,
	...
	["data/lots/getPrevLot"],
	{ tags: ["lots"] },
);

export const getNextLot = unstable_cache(
	async (
		auctionId: number,
		currentInternalLotNumber: number | null | undefined,
		locale?: string,
	...
	["data/lots/getNextLot"],
	{ tags: ["lots"] },
);

export const getSimilarLots = unstable_cache(
	async (
		auctionId: number,
	...
	["data/lots/getSimilarLots"],
	{ tags: ["lots"] },
);

export const getExceptionLots = unstable_cache(
	async (): Promise<Lot[]> => {
	...
	["data/lots/getExceptionLots"],
	{ tags: ["site-settings", "lots"] },
);
